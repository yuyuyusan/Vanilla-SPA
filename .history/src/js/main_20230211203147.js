...
} else if("/about" == location.pathname) {
  topHeader.classList.add('topHidden');
} else if("/skill" == location.pathname) {
  topHeader.classList.add('topHidden');
} else if("/works" == location.pathname) {
  topHeader.classList.add('topHidden');
} else if("/info" == location.pathname) {
  topHeader.classList.add('topHidden');
}
