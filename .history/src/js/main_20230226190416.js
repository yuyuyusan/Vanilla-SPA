...
const meteo = async () => {
  try {
    ...
    return console.log(res.data.daily.temperature_2m_max[0]),console.log(res.data.daily.temperature_2m_min[0]);
  } catch (error) {
...
const newDiv = weather.appendChild(div);
newDiv.textContent = meteo();

console.log(typeof, meteo())
meteo();
